...
function setup() 
{
  ...
  rectangleObject = new rectangle(200, 300, 200, 30, "blue");
   circleObject = new bigcircle(410, 450, 60, "orange");
   triangleObject = new smalltriangle( 75, 160, 140, 300, 75, 350, "green");
